...
exports.creerGrille = creerGrille;
...
function creerGrille() {
  ...
  for (i = 0; i < nbLignes; i++) {
    ...
    for (j = 0; j < nbColonnes; j++) {
      ...
      tdElt.id = x + '-' + y;
      tdElt.innerHTML = "".concat(i, " - ").concat(j);
      document.getElementById("line-".concat(y)).appendChild(tdElt);
      x++; // aller à droite
      // passer à la ligne

      if (document.getElementById("line-".concat(y)).children.length == nbColonnes) {
        y++;
        x = 0;
      }
    }
...
},{}]},{},["../../../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","js/map.js"], null)
